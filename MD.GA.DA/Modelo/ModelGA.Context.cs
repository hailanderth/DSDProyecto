...
namespace MD.GA.BE.Entidades
{
    ...
    public partial class GestionAlmacen : DbContext
    {
        ...
        public virtual ObjectResult<Articulo> SP_LISTAR_ARTICULOS_BY_STOCK(Nullable<int> idArea, string nombreArticulo, Nullable<bool> considerarStock, Nullable<bool> bajoStock, Nullable<bool> sinStock, Nullable<int> idPuesto)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Articulo>("SP_LISTAR_ARTICULOS_BY_STOCK", idAreaParameter, nombreArticuloParameter, considerarStockParameter, bajoStockParameter, sinStockParameter, idPuestoParameter);
        }
    
        public virtual ObjectResult<Articulo> SP_LISTAR_ARTICULOS_BY_STOCK(Nullable<int> idArea, string nombreArticulo, Nullable<bool> considerarStock, Nullable<bool> bajoStock, Nullable<bool> sinStock, Nullable<int> idPuesto, MergeOption mergeOption)
        {
            var idAreaParameter = idArea.HasValue ?
                new ObjectParameter("idArea", idArea) :
                new ObjectParameter("idArea", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Articulo>("SP_LISTAR_ARTICULOS_BY_STOCK", mergeOption, idAreaParameter, nombreArticuloParameter, considerarStockParameter, bajoStockParameter, sinStockParameter, idPuestoParameter);
        }
